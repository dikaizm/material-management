    ...
    <form method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" id="customer_name" name="customer_name"
                  ...
                  value="{{ old('customer_name') }}" required="required" autocomplete="customer_name">
                @error('customer_name')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
              ...
              <div class="form-group">
                ...
                <input type="text" id="customer_code" name="customer_code"
                  ...
                  value="{{ old('customer_code') }}" required="required" autocomplete="customer_code">
                @error('customer_code')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
              ...
              <div class="form-group">
                ...
                <input type="tel" id="customer_phone" name="customer_phone"
                  ...
                  value="{{ old('customer_phone') }}" required="required" autocomplete="customer_phone">
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <input type="submit" value="Tambah Customer" class="btn btn-success float-right">
        </div>
      </div>
