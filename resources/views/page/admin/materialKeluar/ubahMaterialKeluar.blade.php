...
@section('judul', 'Edit Material Keluar')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Edit Material Keluar</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old('waktu', $material_keluar->waktu) }}"
                                required="required"
                                autocomplete="waktu">
                            @error('waktu')
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old('jumlah', $material_keluar->jumlah) }}"
                                required="required"
                                autocomplete="jumlah">
                            @error('jumlah')
                            <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old('satuan', $material_keluar->satuan) }}"
                                required="required"
                                autocomplete="satuan">
                            @error('satuan')
                            <span class="invalid-feedback" role="alert">
