            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" id="supplier_name" name="supplier_name"
                  ...
                  value="{{ isset($data) ? $data->name : old('supplier_name') }}" required="required"
              ...
              <div class="form-group">
                ...
                <input type="text" id="supplier_code" name="supplier_code"
                  ...
                  value="{{ isset($data) ? $data->code : old('supplier_code') }}" required="required"
              ...
              <div class="form-group">
                ...
                <input type="tel" id="supplier_phone" name="supplier_phone"
                  ...
                  value="{{ isset($data) ? $data->phone : old('supplier_phone') }}" required="required" autocomplete="supplier_phone">
