@php
  $links = [
      ...
      [
          ...
          'href' => [
              [
                  'section_text' => 'Data Material',
                  'section_icon' => 'far fa-circle',
                  'section_href' => route('dataMaterial.index'),
              ],
              [
                  'section_text' => 'Tambah Data Material',
                  'section_icon' => 'far fa-circle',
                  'section_href' => route('dataMaterial.add'),
              ],
          ],
      ],
      [
          ...
          'href' => [
              ...
              [
                  ...
                  'section_icon' => 'far fa-circle',
                  'section_href' => route('materialMasuk.add'),
              ],
          ],
      ],
      [
